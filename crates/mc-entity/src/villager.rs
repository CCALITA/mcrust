...
pub fn default_trades(profession: VillagerProfession, level: u8) -> Vec<TradeOffer> {
    match (profession, level) {
        ...
        (VillagerProfession::Librarian, 1) => vec![
            ...
            TradeOffer {
                input1: (2, 1),   // 1 emerald
                input2: Some((11, 1)), // + 1 book
                output: (12, 1),  // 1 enchanted book
                max_uses: 12,
                current_uses: 0,
                xp_reward: 2,
            },
        ...
        (VillagerProfession::Armorer, 2) => vec![
            TradeOffer {
                input1: (2, 3),   // 3 emeralds
                input2: None,
                output: (32, 1),  // 1 iron chestplate
                max_uses: 12,
                current_uses: 0,
                xp_reward: 5,
            },
        ...
        (VillagerProfession::Weaponsmith, 2) => vec![
            ...
            TradeOffer {
                input1: (2, 2),   // 2 emeralds
                input2: None,
                output: (41, 1),  // 1 iron sword
                max_uses: 12,
                current_uses: 0,
                xp_reward: 5,
            },
        ...
        (VillagerProfession::Leatherworker, 2) => vec![
            ...
            TradeOffer {
                input1: (2, 7),   // 7 emeralds
                input2: None,
                output: (72, 1),  // 1 leather tunic
                max_uses: 12,
                current_uses: 0,
                xp_reward: 5,
            },
        ...
        (VillagerProfession::Cartographer, 2) => vec![
            ...
            TradeOffer {
                input1: (2, 13),  // 13 emeralds
                input2: Some((92, 1)), // + 1 compass
                output: (93, 1),  // 1 ocean explorer map
                max_uses: 12,
                current_uses: 0,
                xp_reward: 5,
            },
        ...
        (VillagerProfession::Mason, 2) => vec![
            ...
            TradeOffer {
                input1: (2, 1),    // 1 emerald
                input2: None,
                output: (103, 4),  // 4 chiseled stone bricks
                max_uses: 16,
                current_uses: 0,
                xp_reward: 5,
            },
...
mod tests {
    ...
    // -- All professions have L1 trades (except Nitwit) ----------------------
